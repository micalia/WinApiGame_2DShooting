...
PROTOBUF_CONSTEXPR S_PlayerMissileMove::S_PlayerMissileMove(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.missileinfo_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct S_PlayerMissileMoveDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_PlayerMissileMoveDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_PlayerMissileMoveDefaultTypeInternal() {}
  union {
    S_PlayerMissileMove _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_PlayerMissileMoveDefaultTypeInternal _S_PlayerMissileMove_default_instance_;
PROTOBUF_CONSTEXPR S_EnemyDamaged::S_EnemyDamaged(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.enemyinfo_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct S_EnemyDamagedDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_EnemyDamagedDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_EnemyDamagedDefaultTypeInternal() {}
  union {
    S_EnemyDamaged _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_EnemyDamagedDefaultTypeInternal _S_EnemyDamaged_default_instance_;
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerMissileMove, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerMissileMove, _impl_.missileinfo_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_EnemyDamaged, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_EnemyDamaged, _impl_.enemyinfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_PlayerDamaged, _impl_.info_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 102, -1, -1, sizeof(::Protocol::S_PlayerMissileMove)},
  { 109, -1, -1, sizeof(::Protocol::S_EnemyDamaged)},
  { 116, -1, -1, sizeof(::Protocol::S_PlayerDamaged)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_S_PlayerMissileMove_default_instance_._instance,
  &::Protocol::_S_EnemyDamaged_default_instance_._instance,
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "myMissileInfo\"@\n\023S_PlayerMissileMove\022)\n\013"
  "missileInfo\030\001 \001(\0132\024.Protocol.ObjectInfo\""
  "8\n\016S_EnemyDamaged\022&\n\tenemyInfo\030\001 \001(\0132\023.P"
  "rotocol.EnemyInfo\"5\n\017S_PlayerDamaged\022\"\n\004"
  "info\030\001 \001(\0132\024.Protocol.ObjectInfob\006proto3"
  ;
...
class S_PlayerMissileMove::_Internal {
 public:
  static const ::Protocol::ObjectInfo& missileinfo(const S_PlayerMissileMove* msg);
};

const ::Protocol::ObjectInfo&
S_PlayerMissileMove::_Internal::missileinfo(const S_PlayerMissileMove* msg) {
  return *msg->_impl_.missileinfo_;
}
void S_PlayerMissileMove::clear_missileinfo() {
  if (GetArenaForAllocation() == nullptr && _impl_.missileinfo_ != nullptr) {
    delete _impl_.missileinfo_;
  }
  _impl_.missileinfo_ = nullptr;
}
S_PlayerMissileMove::S_PlayerMissileMove(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.S_PlayerMissileMove)
}
S_PlayerMissileMove::S_PlayerMissileMove(const S_PlayerMissileMove& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  S_PlayerMissileMove* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.missileinfo_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_missileinfo()) {
    _this->_impl_.missileinfo_ = new ::Protocol::ObjectInfo(*from._impl_.missileinfo_);
  }
  // @@protoc_insertion_point(copy_constructor:Protocol.S_PlayerMissileMove)
}

inline void S_PlayerMissileMove::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
S_PlayerMissileMove::~S_PlayerMissileMove() {
  // @@protoc_insertion_point(destructor:Protocol.S_PlayerMissileMove)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_PlayerMissileMove::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.missileinfo_;
}

void S_PlayerMissileMove::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void S_PlayerMissileMove::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_PlayerMissileMove)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* S_PlayerMissileMove::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_missileinfo(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_PlayerMissileMove::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_PlayerMissileMove)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // .Protocol.ObjectInfo missileInfo = 1;
  if (this->_internal_has_missileinfo()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, _Internal::missileinfo(this),
        _Internal::missileinfo(this).GetCachedSize(), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_PlayerMissileMove)
  return target;
}

size_t S_PlayerMissileMove::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_PlayerMissileMove)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_PlayerMissileMove::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    S_PlayerMissileMove::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_PlayerMissileMove::GetClassData() const { return &_class_data_; }


void S_PlayerMissileMove::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<S_PlayerMissileMove*>(&to_msg);
  auto& from = static_cast<const S_PlayerMissileMove&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_PlayerMissileMove)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_missileinfo()) {
    _this->_internal_mutable_missileinfo()->::Protocol::ObjectInfo::MergeFrom(
        from._internal_missileinfo());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void S_PlayerMissileMove::CopyFrom(const S_PlayerMissileMove& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_PlayerMissileMove)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_PlayerMissileMove::IsInitialized() const {
  return true;
}

void S_PlayerMissileMove::InternalSwap(S_PlayerMissileMove* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.missileinfo_, other->_impl_.missileinfo_);
}

::PROTOBUF_NAMESPACE_ID::Metadata S_PlayerMissileMove::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
class S_EnemyDamaged::_Internal {
 public:
  static const ::Protocol::EnemyInfo& enemyinfo(const S_EnemyDamaged* msg);
};

const ::Protocol::EnemyInfo&
S_EnemyDamaged::_Internal::enemyinfo(const S_EnemyDamaged* msg) {
  return *msg->_impl_.enemyinfo_;
}
void S_EnemyDamaged::clear_enemyinfo() {
  if (GetArenaForAllocation() == nullptr && _impl_.enemyinfo_ != nullptr) {
    delete _impl_.enemyinfo_;
  }
  _impl_.enemyinfo_ = nullptr;
}
S_EnemyDamaged::S_EnemyDamaged(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.S_EnemyDamaged)
}
S_EnemyDamaged::S_EnemyDamaged(const S_EnemyDamaged& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  S_EnemyDamaged* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.enemyinfo_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.S_EnemyDamaged)
}

inline void S_EnemyDamaged::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
S_EnemyDamaged::~S_EnemyDamaged() {
  // @@protoc_insertion_point(destructor:Protocol.S_EnemyDamaged)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_EnemyDamaged::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.enemyinfo_;
}

void S_EnemyDamaged::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void S_EnemyDamaged::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_EnemyDamaged)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* S_EnemyDamaged::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* S_EnemyDamaged::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_EnemyDamaged)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_EnemyDamaged)
  return target;
}

size_t S_EnemyDamaged::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_EnemyDamaged)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_EnemyDamaged::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    S_EnemyDamaged::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_EnemyDamaged::GetClassData() const { return &_class_data_; }


void S_EnemyDamaged::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<S_EnemyDamaged*>(&to_msg);
  auto& from = static_cast<const S_EnemyDamaged&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_EnemyDamaged)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void S_EnemyDamaged::CopyFrom(const S_EnemyDamaged& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_EnemyDamaged)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_EnemyDamaged::IsInitialized() const {
  return true;
}

void S_EnemyDamaged::InternalSwap(S_EnemyDamaged* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.enemyinfo_, other->_impl_.enemyinfo_);
}

::PROTOBUF_NAMESPACE_ID::Metadata S_EnemyDamaged::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
class S_PlayerDamaged::_Internal {
 public:
  static const ::Protocol::ObjectInfo& info(const S_PlayerDamaged* msg);
};

const ::Protocol::ObjectInfo&
S_PlayerDamaged::_Internal::info(const S_PlayerDamaged* msg) {
  return *msg->_impl_.info_;
}
void S_PlayerDamaged::clear_info() {
  if (GetArenaForAllocation() == nullptr && _impl_.info_ != nullptr) {
    delete _impl_.info_;
  }
  _impl_.info_ = nullptr;
...
template<> PROTOBUF_NOINLINE ::Protocol::S_PlayerMissileMove*
Arena::CreateMaybeMessage< ::Protocol::S_PlayerMissileMove >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_PlayerMissileMove >(arena);
}
template<> PROTOBUF_NOINLINE ::Protocol::S_EnemyDamaged*
Arena::CreateMaybeMessage< ::Protocol::S_EnemyDamaged >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_EnemyDamaged >(arena);
}

...
void Game::Init(HWND hwnd)
{
	...
	GET_SINGLE(ResourceManager)->Init(hwnd, fs::path(L"C:\\ProgramingWorks\\WinApiGame\\WinApiGame_2DShooting\\2DShooting_SeolBin\\Resources"));  // 노트북
...
void Game::Render()
{
	...
	/*{
		...
		::TextOut(hdcBack, 300, 220, str.c_str(), static_cast<int32>(str.size()));
	}*/
